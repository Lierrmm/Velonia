#ifndef TU24SP_DRAW_H
#define TU24SP_DRAW_H
...
namespace TU24SP
{
	...
	void drawLine(float X1, float Y1, float X2, float Y2, float Width, float* Colors) {
		...
		CG_DrawRotatedPicPhysical(0x8278BE88, X, Y, L2, Width, Angle, Colors, Material_RegisterHandleInt("white", 0));
	}
	...
	inline void drawBoneLine(CEntity entity, int ent, char* tagname1, char* tagname2, float* color) {
	...
	inline void draw3DBox(int client, float* sColor) {
		auto Center = Centity_s[client].pose.origin;
