...
namespace TU24
{
	...
	void addiSlider(int i, const char* text, int var, int min, int max) {
		...
		addOption(i, text);
		CG_DrawRotatedPicPhysical(0x82732100, 1114 + 1, 29 + ((i+1) * 28) + 2, X, 8, 0, Smoke, Material_RegisterHandleInt("white", 0));
	...
	void addiSliderOption(int i, const char* text, int var, int min, int max, bool selected)
	{
		...
		addOption(i, text);
		CG_DrawRotatedPicPhysical(0x82732100, 1115, 29 + ((i+1) * 28) + 2, X, 8, 0, Smoke, Material_RegisterHandleInt("white", 0));
